...
curl -X GET https://api.plexe.ai/deployments/{deployment_id} \
...
```json
{
  ...
  "status": "READY",
  "endpoint": "https://api.plexe.ai/predict/dep_abc123def456",
...
```bash
curl -X POST https://api.plexe.ai/predict/{deployment_id} \
  -H "x-api-key: YOUR_API_KEY" \
...
async function getPrediction(inputData) {
  ...
  const endpoint = `https://api.plexe.ai/predict/${deploymentId}`;
...
```bash
curl -X POST https://api.plexe.ai/predict/{deployment_id}/batch \
  -H "x-api-key: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "inputs": [
...
```bash
curl -X POST https://api.plexe.ai/predict/{deployment_id}/async-batch \
  -H "x-api-key: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST https://api.plexe.ai/predict/{deployment_id}/validate \
  -H "x-api-key: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "feature1": "value1",
...
```bash
curl -X POST https://api.plexe.ai/predict/{deployment_id}?include=result,processing_time_ms \
  -H "x-api-key: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "feature1": "value1",
...
```bash
curl -X POST https://api.plexe.ai/predict/{deployment_id}?explain=true \
  -H "x-api-key: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "feature1": "value1",
...
```bash
curl -X POST https://api.plexe.ai/predict/{deployment_id}?model_version=2 \
  -H "x-api-key: YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "feature1": "value1",
